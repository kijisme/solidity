...
'''获取完整call图'''
def get_full_call_graph(dataset_dir, vulnerabilities_info):
    bug_full_graph = None
...
'''获取单种漏洞图'''
def get_vuln_call_graph(dataset_dir, vuln_dataset_dir, isSave=False):
    ...
    bug_full_graph = get_full_call_graph(dataset_dir, vulnerabilities_info)
    # ##########################################
